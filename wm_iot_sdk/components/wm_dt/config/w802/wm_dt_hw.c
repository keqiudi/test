...
const static wm_dt_hw_pin_cfg_t dt_hw_i2s_pin[] = {
    { .pin_num = WM_GPIO_NUM_7,  .pin_mux = WM_GPIO_IOMUX_FUN3 }, // MCLK
    { .pin_num = WM_GPIO_NUM_24, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // BCLK
    { .pin_num = WM_GPIO_NUM_25, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // LRCLK
    { .pin_num = WM_GPIO_NUM_26, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // DI
    { .pin_num = WM_GPIO_NUM_27, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // DO
};
...
const static wm_dt_hw_pin_cfg_t dt_hw_sdh_spi_pin_cfg[] = {
    { .pin_num = WM_GPIO_NUM_9,  .pin_mux = WM_GPIO_IOMUX_FUN1 }, /**< CLK - PA9 */
    { .pin_num = WM_GPIO_NUM_10, .pin_mux = WM_GPIO_IOMUX_FUN1 }, /**< MOSI(SDIO_CMD) - PA10 */
};
...
const static wm_dt_hw_tft_lcd_spi_t dt_hw_nv3041a = {
    ...
    .spi_cfg = {
        ...
        .pin_cs = {
            .pin_num = WM_GPIO_NUM_14,  /**< CS - PA14 */
            .pin_mux = WM_GPIO_IOMUX_FUN5,
            .pin_dir = WM_GPIO_DIR_OUTPUT,
            .pin_pupd = WM_GPIO_FLOAT,
        },
    },
    .io_lcd_reset = WM_GPIO_NUM_7,      /**< RST - PA07 */
    .io_lcd_led = WM_GPIO_NUM_2,        /**< LED - PA02 */
    .io_lcd_dcx = WM_GPIO_NUM_12,       /**< DCX - PA12 */
    .io_lcd_te = WM_GPIO_NUM_45,        /**< TE  - PB29 */
...
const static wm_dt_hw_tft_lcd_spi_t dt_hw_gz035 = {
    ...
    .io_lcd_reset = WM_GPIO_NUM_7,      /**< RST - PA07 */
    .io_lcd_led = WM_GPIO_NUM_29,       /**< LED - PB13 */
    .io_lcd_dcx = WM_GPIO_NUM_1,        /**< DCX - PA01 */
    .io_lcd_te = WM_GPIO_NUM_24,        /**< TE  - PB08 */
    .spi_device_name = "sdspi",
    .gpio_device_name="gpio",
};
...
const static wm_dt_hw_pin_cfg_t dt_hw_psram_pin_cfg[] = {
    /**< SCLK */
    { .pin_num = WM_GPIO_NUM_16, .pin_mux = WM_GPIO_IOMUX_FUN4 },
    /**< CS */
    { .pin_num = WM_GPIO_NUM_17, .pin_mux = WM_GPIO_IOMUX_FUN4 },
    /**< SIO0 */
