...
const static wm_dt_hw_pin_cfg_t dt_hw_pwm_pin[] = {
    { .pin_num = WM_GPIO_NUM_16, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // PWM channel0
    { .pin_num = WM_GPIO_NUM_17, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // PWM channel1
    { .pin_num = WM_GPIO_NUM_18, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // PWM channel2
    { .pin_num = WM_GPIO_NUM_19, .pin_mux = WM_GPIO_IOMUX_FUN1 }, // PWM channel3
    { .pin_num = WM_GPIO_NUM_4,  .pin_mux = WM_GPIO_IOMUX_FUN3 }, // PWM channel4
