...
START_TEST(test_dhcp)
{
  ...
  fail_unless(txpacket == 3, "TX %d packets, expected 3", txpacket); /* ARP requests sent */
...
START_TEST(test_dhcp_relayed)
{
  ...
  fail_unless(txpacket == 3, "txpkt should be 3, is %d", txpacket); /* ARP requests sent */
  ...
  fail_unless(txpacket == 3, "txpacket = %d", txpacket);
