...
#define TESTBUFSIZE_2 20
static u8_t *testbuf_1  = (void*)0x1;
static u8_t *testbuf_1a = (void*)0x1;
static u8_t *testbuf_2  = (void*)0x2;
static u8_t *testbuf_2a = (void*)0x2;
...
START_TEST(test_pbuf_queueing_bigger_than_64k)
{
  ...
  fail_unless(rest2->tot_len == (u16_t)((TESTBUFSIZE_2) & 0xFFFF));
...
START_TEST(test_pbuf_take_at_edge)
{
  ...
  struct pbuf *p = pbuf_alloc(PBUF_RAW, 4096, PBUF_POOL);
