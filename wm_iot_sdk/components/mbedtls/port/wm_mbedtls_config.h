 ...
 *
 */
#if CONFIG_MBEDTLS_ENABLE_HARD_DRV
...
//#define MBEDTLS_PLATFORM_STD_CALLOC        wm_os_internal_calloc//calloc /**< Default allocator to use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_FREE          wm_os_internal_free//free /**< Default free to use, can be undefined */
...
#define MBEDTLS_PLATFORM_CALLOC_MACRO              wm_os_internal_calloc //calloc /**< Default allocator macro to use, can be undefined */
#define MBEDTLS_PLATFORM_FREE_MACRO                wm_os_internal_free //free /**< Default free macro to use, can be undefined */
