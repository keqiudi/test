 ...
 */
typedef size_t (*settings_read_cb)(void *cb_arg, void *data, size_t len);
...
/**
 * Initialize resource of settings and backend
 *
...
/**
 * DeInitialize resource of settings and backend
 *
 * Must be called at application down.
 *
 * @return 0 on success, non-zero on failure.
 */
