...
struct bt_has_features_param {
	 ...
	 * and CONFIG_BT_HAS_PRESET_COUNT is non-zero.
	 */
...
struct bt_has_preset_register_param {
	 ...
	 * CONFIG_BT_HAS_PRESET_NAME_DYNAMIC configuration option has been enabled.
 ...
 * This symbol is linkable if CONFIG_BT_HAS_PRESET_COUNT is non-zero.
 *
