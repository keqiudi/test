 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_SET_BEARER_SIGNAL_INTERVAL must be set
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_ORIGINATE_CALL must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_TERMINATE_CALL must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_HOLD_CALL must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_ACCEPT_CALL must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_RETRIEVE_CALL must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_JOIN_CALLS must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_BEARER_PROVIDER_NAME must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_BEARER_UCI must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_BEARER_TECHNOLOGY must be set
 * for this function to be effective.
 */
 ...
 * @return int          0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_BEARER_URI_SCHEMES_SUPPORTED_LIST must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_BEARER_SIGNAL_STRENGTH must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_READ_BEARER_SIGNAL_INTERVAL must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_BEARER_LIST_CURRENT_CALLS must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_CCID must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_INCOMING_URI must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_STATUS_FLAGS must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_INCOMING_CALL must be set
 * for this function to be effective.
 */
 ...
 * @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_CALL_FRIENDLY_NAME must be set
 * for this function to be effective.
 */
 ...
 *  @return              int 0 on success, errno value on fail.
 *
 * @note CONFIG_BT_TBS_CLIENT_OPTIONAL_OPCODES must be set
 * for this function to be effective.
 */
