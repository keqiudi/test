 ...
 * BT_CAP_ACCEPTOR_SET_MEMBER. If BT_CAP_ACCEPTOR_SET_MEMBER
 ...
 *
 * @note Support for sending must be supported, determined by CONFIG_BT_AUDIO_TX.
 *
 * @param stream   Stream object.
 ...
 *
 * @note CONFIG_BT_CAP_INITIATOR and
 * CONFIG_BT_BAP_UNICAST_CLIENT must be enabled for this function
 * to be enabled.
 *
 ...
 * * *
 * @note CONFIG_BT_CAP_INITIATOR and
 * CONFIG_BT_BAP_BROADCAST_SOURCE must be enabled for this function
 * to be enabled.
 *
 * @param[in]  param             Parameters to start the audio streams.
 ...
 * extended advertising data with BT_UUID_BROADCAST_AUDIO_VAL as
 *  BT_DATA_SVC_DATA16.
 *
 ...
 *
 * @note CONFIG_BT_CAP_INITIATOR,
 * CONFIG_BT_BAP_UNICAST_CLIENT and
 * CONFIG_BT_BAP_BROADCAST_SOURCE must be enabled for this function
 * to be enabled.
 *
