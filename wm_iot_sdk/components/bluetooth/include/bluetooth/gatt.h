 ...
 *
 *  When using CONFIG_BT_SETTINGS then all services that should have
 *  bond configuration loaded, i.e. CCC values, must be registered before
 *  calling settings_load.
 *
 *  When using CONFIG_BT_GATT_CACHING and CONFIG_BT_SETTINGS
 *  then all services that should be included in the GATT Database Hash
 *  calculation should be added before calling settings_load.
 ...
 *               a bitmap of bt_gatt_perm values.
 ...
 *               a bitmap of  bt_gatt_perm values.
 *  @param _read Attribute read callback ( bt_gatt_attr_read_func_t).
 *  @param _write Attribute write callback ( bt_gatt_attr_write_func_t).
 ...
 *  @param conn Connection object.
 *  @param attr Attribute object.
 *  @param ccc_type The subscription type,  BT_GATT_CCC_NOTIFY and/or
 ...
 *  by CONFIG_BT_L2CAP_TX_BUF_COUNT.
 *
 ...
 *  -------------------------------------|-------------------------|---------------------------
 *  	 BT_GATT_DISCOVER_PRIMARY        | any                     | @ref bt_gatt_service_val
 *  	 BT_GATT_DISCOVER_SECONDARY      | any                     | @ref bt_gatt_service_val
 *  	 BT_GATT_DISCOVER_INCLUDE        | any                     | @ref bt_gatt_include
 *  	 BT_GATT_DISCOVER_CHARACTERISTIC | any                     | @ref bt_gatt_chrc
 *  	 BT_GATT_DISCOVER_STD_CHAR_DESC  | 		BT_UUID_GATT_CEP   | @ref bt_gatt_cep
 *  	 BT_GATT_DISCOVER_STD_CHAR_DESC  | 		BT_UUID_GATT_CCC   | @ref bt_gatt_ccc
 *  	 BT_GATT_DISCOVER_STD_CHAR_DESC  | 		BT_UUID_GATT_SCC   | @ref bt_gatt_scc
 *  	 BT_GATT_DISCOVER_STD_CHAR_DESC  | 		BT_UUID_GATT_CPF   | @ref bt_gatt_cpf
 ...
 *  controlled by CONFIG_BT_L2CAP_TX_BUF_COUNT.
 */
...
enum bt_gatt_subscribe_flag {
	 ...
	 *  CONFIG_BT_GATT_AUTO_RESUBSCRIBE quirk is enabled.
	 *
	 *  @note Internal use only.
	 */
