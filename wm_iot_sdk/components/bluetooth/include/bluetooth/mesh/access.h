 ...
 *		      Shall not exceed CONFIG_BT_MESH_MODEL_KEY_COUNT.
 *  @param _grps      Number of addresses that the model can be subscribed to.
 *		      Shall not exceed CONFIG_BT_MESH_MODEL_GROUP_COUNT.
...
struct bt_mesh_model_cb {
	 ...
	 *
	 *  Free resource allocated during initialization .
	 *
 ...
 *                  SETTINGS_MAX_DIR_DEPTH bytes will be used at most.
