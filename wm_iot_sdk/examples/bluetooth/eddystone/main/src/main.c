...
static const struct bt_data ad[] = {
    ...
    BT_DATA_BYTES(BT_DATA_UUID128_ALL, 0x95, 0xe2, 0xed, 0xeb, 0x1b, 0xa0, 0x39, 0x8a, 0xdf, 0x4b, 0xd3, 0x8e, 0x00, 0x75, 0xc8,
                  0xa3),
};

/* Eddystone Service Variables */
/* Service UUID a3c87500-8ed3-4bdf-8a39-a01bebede295 */
static struct bt_uuid_128 eds_uuid = BT_UUID_INIT_128(BT_UUID_128_ENCODE(0xa3c87500, 0x8ed3, 0x4bdf, 0x8a39, 0xa01bebede295));
...
static struct eds_capabilities eds_caps = {
    .version = EDS_VERSION, .slots = NUMBER_OF_SLOTS, .slot_types = EDS_SLOT_URL, /* TODO: Add support for other slot types */
};
...
static ssize_t read_caps(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
...
static ssize_t read_slot(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
    return bt_gatt_attr_read(conn, attr, buf, len, offset, &eds_active_slot, sizeof(eds_active_slot));
}

static ssize_t write_slot(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len, uint16_t offset,
                          uint8_t flags)
{
    uint8_t value;
...
static ssize_t read_tx_power(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
...
static ssize_t write_tx_power(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len,
...
static ssize_t read_adv_tx_power(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len,
                                 uint16_t offset)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
static ssize_t write_adv_tx_power(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len,
                                  uint16_t offset, uint8_t flags)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
static ssize_t read_lock(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
static ssize_t write_lock(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len, uint16_t offset,
                          uint8_t flags)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
    uint8_t value;
...
static ssize_t read_unlock(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
static ssize_t write_unlock(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len,
                            uint16_t offset, uint8_t flags)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
static ssize_t read_ecdh(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
...
static ssize_t read_eid(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
    uint8_t *value = attr->user_data;
...
static ssize_t read_adv_data(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
static int eds_slot_restart(struct eds_slot *slot, uint8_t type)
{
    ...
    wm_log_info("Advertising as %s", addr_s);
...
static ssize_t write_adv_data(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len,
                              uint16_t offset, uint8_t flags)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
    uint8_t type;
    ...
    switch (type) {
		 ...
		 */
            slot->ad[2].data_len = MIN(slot->ad[2].data_len, len + EDS_URL_WRITE_OFFSET - 1);
            memcpy((uint8_t *)slot->ad[2].data + EDS_URL_WRITE_OFFSET, buf + 1, slot->ad[2].data_len - EDS_URL_WRITE_OFFSET);
...
static ssize_t write_reset(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len,
                           uint16_t offset, uint8_t flags)
{
...
static ssize_t read_connectable(struct bt_conn *conn, const struct bt_gatt_attr *attr, void *buf, uint16_t len, uint16_t offset)
{
...
static ssize_t write_connectable(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len,
                                 uint16_t offset, uint8_t flags)
{
    struct eds_slot *slot = &eds_slots[eds_active_slot];
...
BT_GATT_SERVICE_DEFINE(
    ...
    BT_GATT_CHARACTERISTIC(&eds_caps_uuid.uuid, BT_GATT_CHRC_READ, BT_GATT_PERM_READ, read_caps, NULL, &eds_caps),
    /* Active slot: Must be unlocked for both read and write. */
    BT_GATT_CHARACTERISTIC(&eds_slot_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
                           read_slot, write_slot, NULL),
    /* Advertising Interval: Must be unlocked for both read and write. */
    BT_GATT_CHARACTERISTIC(&eds_intv_uuid.uuid, BT_GATT_CHRC_READ, BT_GATT_PERM_READ, read_interval, NULL, NULL),
    /* Radio TX Power: Must be unlocked for both read and write. */
    BT_GATT_CHARACTERISTIC(&eds_tx_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
    ...
    BT_GATT_CHARACTERISTIC(&eds_adv_tx_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
                           BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_adv_tx_power, write_adv_tx_power, NULL),
    /* Lock State:
	 * Readable in locked or unlocked state.
	 * Writeable only in unlocked state.
	 */
    BT_GATT_CHARACTERISTIC(&eds_lock_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
    ...
    BT_GATT_CHARACTERISTIC(&eds_unlock_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
                           BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_unlock, write_unlock, NULL),
    /* Public ECDH Key: Readable only in unlocked state. Never writable. */
    BT_GATT_CHARACTERISTIC(&eds_ecdh_uuid.uuid, BT_GATT_CHRC_READ, BT_GATT_PERM_READ, read_ecdh, NULL, &eds_ecdh),
    /* EID Identity Key:Readable only in unlocked state. Never writable. */
    BT_GATT_CHARACTERISTIC(&eds_eid_uuid.uuid, BT_GATT_CHRC_READ, BT_GATT_PERM_READ, read_eid, NULL, eds_eid),
    /* ADV Slot Data: Must be unlocked for both read and write. */
    BT_GATT_CHARACTERISTIC(&eds_data_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, BT_GATT_PERM_READ | BT_GATT_PERM_WRITE,
                           read_adv_data, write_adv_data, NULL),
    /* ADV Factory Reset: Must be unlocked for write. */
    BT_GATT_CHARACTERISTIC(&eds_reset_uuid.uuid, BT_GATT_CHRC_WRITE, BT_GATT_PERM_WRITE, NULL, write_reset, NULL),
    ...
    BT_GATT_CHARACTERISTIC(&eds_connectable_uuid.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE,
                           BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_connectable, write_connectable, NULL));
...
static void bt_ready(int err)
{
    ...
    wm_log_info("Initial advertising as %s", addr_s);

    k_work_schedule(&idle_work, EDS_IDLE_TIMEOUT);

    wm_log_info("Configuration mode: waiting connections...");
}

static void idle_timeout(struct k_work *work)
{
    if (eds_slots[eds_active_slot].type == EDS_TYPE_NONE) {
        wm_log_info("Switching to Beacon mode %u.", eds_active_slot);
