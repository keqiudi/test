...
extern const uint8_t mqtt_eclipseprojects_io_crt_start[] asm("__binary_main_src_mqtt_eclipseprojects_io_crt");
extern const uint32_t mqtt_eclipseprojects_io_crt_length asm("__binary_main_src_mqtt_eclipseprojects_io_crt_length");

extern const uint8_t mqtt_eclipseprojects_io_key_start[] asm("__binary_main_src_mqtt_eclipseprojects_io_key");
extern const uint32_t mqtt_eclipseprojects_io_key_length asm("__binary_main_src_mqtt_eclipseprojects_io_key_length");
...
static void mqtt_app_start(void)
{
    wm_mqtt_client_config_t mqtt_cfg = {
        ...
        .auth_mode = WM_MQTT_CLIENT_AUTH_MODE_NOT_CERT,
    };
