...
set(ELF2BIN_TOOL ${python} ${SDK_PATH}/tools/wm/elf2bin.py)
...
if(all_custom_images)
    ...
    if(custom_image_count GREATER 1)
        math(EXPR custom_image_count "${custom_image_count} - 1")
        set(custom_temp_fls "${CMAKE_BINARY_DIR}/custom_bin/all_custom_files.fls")
